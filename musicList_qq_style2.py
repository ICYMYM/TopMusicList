...
"""
MusicList of QQ:
http://y.qq.com/y/static/toplist/json/features/***/1.js?loginUin=0&hostUin=0&;format=jsonp&inCharset=GB2312&amp;outCharset=utf-8¬ice=0&platform=yqq&jsonpCallback=MusicJsonCallback&needNewCode=0
...
TYPE = [39,10001,10002,10003,37,36,1]
...
defaultFilePath = './MusicList_qq_style2.lst'
...
def getMusicListSong_QQ(typeid):
    musiclist_url = 'http://y.qq.com/y/static/toplist/json/features/{0}/1.js?loginUin=0&hostUin=0&;format=jsonp&inCharset=GB2312&amp;outCharset=utf-8¬ice=0&platform=yqq&jsonpCallback=MusicJsonCallback&needNewCode=0'
